...
const courses = [
    ...
    {'name':'jour390', 'img':'photos/jour390.jpg','description':"intro to sports writing. wrote multiple beat reports and game stories on high school and college sports. also reported on the chicago sky's opening week against the atlanta dream</a>."},
    {'name':'imc301', 'img':'photos/imc301.jpeg','description':"intro to integrated marketing communicationcs. learned the tenets of imc through <a href='https://docs.google.com/presentation/d/1wVc9xUZ-Bt4EBR2n9YDWGOIKNTpc6CP8iX8-S_hTXcc/edit?usp=sharing' target='_blank'>case studies</a>. worked with kohl's to curate and interpret results from a <a href='imc301/kohls.html' target='_blank'>focus group</a>."},
